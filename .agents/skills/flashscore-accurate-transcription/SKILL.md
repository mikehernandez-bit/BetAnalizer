...
5. Excluir `Club Friendlies`, `Club Frien...`, `Amistoso` y equivalentes. Continuar con otra captura hasta tener exactamente 10 partidos oficiales por equipo.
...
- Tras guardar, volver a leer el archivo y comprobar las 10 filas de cada equipo.
